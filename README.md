  ...
  build:
    ...
    steps:
      ...
      - name: Bump version and push tag
        uses: laputansoft/github-tag-action@v4.5
        tag: 0.0.1
        with:
...
- **tag** _(optional)_ - Tag name (default: `0.0.1`).
...
[mathieudutour/github-tag-action](https://github.com/mathieudutour/github-tag-action) - fork from mathieudutour
